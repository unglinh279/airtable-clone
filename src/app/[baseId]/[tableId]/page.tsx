...
export default function TablePage() {
    ...
    const createTable = api.table.create.useMutation({
        onSuccess: () => refetchBase(), // Refetch base data after creating a table
    });

    const refetchBase = api.base.getBase.useQuery({ baseId }).refetch;
    ...
    return (
        <div className="flex flex-col h-screen">
            ...
            <nav className="bg-airtableBlue text-white px-6 py-2 flex justify-between items-center shadow-md">
                <div
                    className="flex items-center justify-between px2 flex-auto top-bar-text-light"
                    style={{ height: '56px', paddingLeft: '20px' }}
                >
                    {/* Left Section */}
                    <div className="flex items-center space-x-6">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            >
                                ...
                                <div
                                    className="absolute inset-0 flex items-center justify-center bg-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
                                >
                                    <svg
